...
CREATE TABLE `godina_studija` (
  ...
  `studijski_program_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `godina_studija` VALUES (1,'2018-01-09','2016-01-03',1,1),(2,'2020-05-07','2016-07-01',2,2),(3,'2020-08-25','2016-09-20',3,3);
