...
CREATE TABLE `nastavnik` (
  ...
  `biografija` varchar(128) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `FKr2d83gmamqri28q2jb1tv5ym7` (`adresa_id`),
  KEY `FKrcmlmbuw8321wdm20agnp1gsr` (`licni_podaci_id`),
  ...
  CONSTRAINT `FKr2d83gmamqri28q2jb1tv5ym7` FOREIGN KEY (`adresa_id`) REFERENCES `adresa` (`id`),
  CONSTRAINT `FKrcmlmbuw8321wdm20agnp1gsr` FOREIGN KEY (`licni_podaci_id`) REFERENCES `licni_podaci` (`id`)
...
INSERT INTO `nastavnik` VALUES (1,'biografija_1',_binary '\0',1,1,1),(2,'biografija_2',_binary '\0',2,2,2),(3,'biografija_3',_binary '\0',3,3,3);
