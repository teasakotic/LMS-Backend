...
public class FileController {	
    ...
    public ResponseEntity<Iterable<Optional<File>>> getTFileByPredmet(@PathVariable Long id) {
        return new ResponseEntity<Iterable<Optional<File>>>(fileService.getFileByPredmet(id), HttpStatus.OK);
    }
